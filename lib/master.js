...
const promisifiedGetCacheConfigValue = (namespace, options, func, funcArgs) => {
...
const promisifiedIncrOrDecr = (namespace, options, func, funcArgs) => {
  const lru = getLruCache(namespace, options);
  return new Promise((resolve) => {
...
const promisifiedGetMultiValues = (namespace, options, func, funcArgs) => {
  const lru = getLruCache(namespace, options);
  return new Promise((resolve) => {
...
const promisifiedSetMultiValues = (namespace, options, func, funcArgs) => {
  const lru = getLruCache(namespace, options);
  return new Promise((resolve) => {
...
const promisifiedDelMultiValues = (namespace, options, func, funcArgs) => {
  const lru = getLruCache(namespace, options);
  return new Promise((resolve) => {
...
const promisifiedDefaultLruFunc = (namespace, options, func, funcArgs) => {
  const lru = getLruCache(namespace, options);
  return new Promise((resolve) => {
...
const getPromisified = (namespace, options) => {
  return (...args) => {
    ...
    if ('mGet' === func) {
      return promisifiedGetMultiValues(namespace, options, func, funcArgs);
    }
    if ('mSet' === func) {
      return promisifiedSetMultiValues(namespace, options, func, funcArgs);
    }
    if ('mDel' === func) {
      return promisifiedDelMultiValues(namespace, options, func, funcArgs);
    }
    if (['decr', 'incr'].includes(func)) {
      return promisifiedIncrOrDecr(namespace, options, func, funcArgs);
    }
    if (['max', 'maxAge', 'stale', 'itemCount', 'length'].includes(func)) {
      return promisifiedGetCacheConfigValue(namespace, options, func, funcArgs);
    }
    return promisifiedDefaultLruFunc(namespace, options, func, funcArgs);
  };
};
